...
encode(Record)->
	...
	Bin2 = [<<MsgID:16>>, Bin],
	ByteSize = erlang:iolist_size(Bin2)+5,
	if ByteSize > 409600 ->
		Bin3 = zlib:compress(Bin2),
		ByteSize2 = erlang:iolist_size(Bin3)+5,
		[<<ByteSize2:32,1:8>>, Bin3];
	true ->
		[<<ByteSize:32,0:8>>,Bin2]
	end.
...
%% 效能测试代码 如果这个地方需要追加已给因为p_fighter改了
-define(Record,{sc_fight_request,[{p_fighter,1,1,1,2000,2000,40,1},
								  {p_fighter,2,2,2,2000,2000,40,1},
								  {p_fighter,3,3,3,2000,2000,40,1},
								  {p_fighter,4,4,4,2000,2000,40,1},
								  {p_fighter,5,5,5,2000,2000,40,1},
								  {p_fighter,6,6,6,2000,2000,40,1},
								  {p_fighter,7,7,-1,2000,2000,40,1},
								  {p_fighter,8,8,-2,2000,2000,40,1},
								  {p_fighter,9,9,-3,2000,2000,40,1},
								  {p_fighter,10,10,-4,2000,2000,40,1},
								  {p_fighter,11,11,-5,2000,2000,40,1},
								  {p_fighter,12,12,-6,2000,2000,40,1}],
