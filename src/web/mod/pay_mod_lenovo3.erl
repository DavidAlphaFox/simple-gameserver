					...
					{RoleAccID,SrcType} = db_sql:get_role_accid_and_type(RoleID2),
					 case SrcType == 21 orelse SrcType == 75 orelse SrcType == 95 orelse SrcType == 29 of
						true ->
							...
							pay_gold2(RoleID2,Amount,QS,Sign2	,95);
						_->
							Reply = ejson:encode({[{<<"result">>,5},{<<"accid">>,RoleAccID}]}),
							Req:ok({"text/html; charset=utf-8", Reply}),
							?ERR("lenovo3 pay for other SrcType:~w ~n",[SrcType])
					end;
				_ ->
...
%% ====================================================================
get_pubKey()->                                                   
	PubKey = <<"-----BEGIN PUBLIC KEY-----\nMIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDE102nX82MUh2H7uzlHTLaNLNNvW1VMOjQoYsn4cy9bYfzRmlNYedNmNk1xLZgiWoNC5jdWlf8d2XarR7gGaGeDymGYo76tcnIDTJRZsJ3UvORlrLSo308U2jJoESmpcp0m3nmIfBRRUyfWvR/tI10dOtDYcNj1otJx8zqkdmnSQIDAQAB\n-----END PUBLIC KEY-----">>,
