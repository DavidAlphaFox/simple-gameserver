...
-define(ACCOUNT_TYPE_TXHD_ARD, 42).
...
pay_gold(Req) ->
    ...
    case Md52 =:= Md53 of
        ...
        true ->
			...
			case RRType == ?ACCOUNT_TYPE_TXHD_ARD  orelse RRType == 13 orelse RRType == 4 orelse RRType == 37 orelse RRType == 57 orelse RRType == 81 orelse RRType == 67 of
				true->
