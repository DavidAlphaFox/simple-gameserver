...
pay_gold(Req) ->
	...
	SignString = 
		case Sub of 
			undefined -> "amount="++Money++"&app_order_id="++AppOrderID++"&app_user_id="++AppUserID++"&serial="++Serial++"&status="++Status++"&client_secret=530a0f1336bd3398590acc43b02a5769";
			_ -> "amount="++Money++"&app_order_id="++AppOrderID++"&app_subject="++Sub++"&app_user_id="++AppUserID++"&serial="++Serial++"&status="++Status++"&client_secret=530a0f1336bd3398590acc43b02a5769"
		end,
				...
				Sign ->
					...
					case RRType of
						116 ->
							...
							pay_gold2(RoleID2,Amount,SignString,Sign,116);
						_ ->
