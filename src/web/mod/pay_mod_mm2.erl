%% 移动MM网游SDK,现在这里的代码和移动MM的是一样的,但以后不一定一样,所以这儿分开处理
-module(pay_mod_mm2).
...
-define(SRCTYPE, 76).
-define(APPKEY,"45EB40171579895B8B5EAD4B5DACED64").
-define(APPID,"300008823025").
		...
		true ->
			...
			case SrcType of
				...
				_->
					...
					Req:ok({"text/html; charset=utf-8", Reply}),
					?ERR("mm2 pay for other SrcType:~w ~n",[SrcType])
			end;
		_ ->
