%% @author lxl
%% @doc @todo Add description to pay_mod_tt.
		...
		true ->
			case get_value(QueryString,<<"payResult">>) of
				<<"1">>  ->
					...
					case RRType of
						110 ->
							pay_gold2(RoleID2,Amount2,QSL,Sign,110),
...
check_sign(QS,Sign) ->
	base64:encode_to_string(erlang:md5(re:replace(QS,"\\+"," ",[global,caseless,{return,list}])++"6fb434302efcf0c78e035994e7c8aa7a"))==Sign.
