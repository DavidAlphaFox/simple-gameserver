				...
				true ->
					...
					case SrcType of
						12->
							...
							pay_gold2(RoleID2,Amount2,QS,NewSign,12);
						_->
							Reply = ejson:encode({[{<<"result">>,5},{<<"accid">>,RoleAccID}]}),
							Req:ok({"text/html; charset=utf-8", Reply}),
							?ERR("ky pay for other SrcType:~w ~n",[SrcType])
					end;	
				_ ->
...
get_pubKey()->
    PubKey = <<"-----BEGIN PUBLIC KEY-----\nMIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDUX9nhZWVG2qWI4dxH411p9Ij/JEUSerx8t69Mmsa2QZfPcBsO2w2M71G+LYRDjEv0mBbKj2NBGJWWolRSTacXDGE4P1uUdPXa8i3ZTUYDFFmjvAKCg2lPa9T7S/PMBFKY+svmBqbDAVGrTUfsMjzD8XDbT0Rkm5HHcLGUIo261wIDAQAB\n-----END PUBLIC KEY-----">>,
